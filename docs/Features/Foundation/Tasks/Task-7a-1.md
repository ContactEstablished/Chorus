...
| `roadmap.md` §6 — **D189(e)** (`roadmap.md:709`) · §7 Phase 7a (`roadmap.md:1948`) | The phase entry that created this task and pre-argued it: *"VENDOR MARKS REPLACE THE TWO-LETTER TILES … The never-colour rule is preserved in full."* **D189(f) explicitly reserved the drawing decision for D184** and took none itself |
