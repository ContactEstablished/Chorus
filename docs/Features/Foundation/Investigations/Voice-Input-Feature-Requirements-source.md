<!--
────────────────────────────────────────────────────────────────────────────
PROVENANCE BANNER — added 2026-08-12 when this file was copied into the repo.
Everything below this banner is the source document byte-for-byte; nothing in
it has been edited.

Origin: C:\Projects\TaxApp\TaxApp\docs\Voice-Input-Feature-Requirements.md
Author: Matthew, working with another model. Dated 2026-08-12.

WHY IT LIVES HERE: it is the input to Phase 5's design, and it was written for a
generic multi-tenant web application rather than for Chorus. The TRANSLATION —
what carries over, what changes, and what drops out — is in
`../Phase-5-VoicePlan.md`. Read that for what Chorus is actually building. Read
this for what was originally asked for.

⚠ THIS FILE IS A RECORD, NOT A SPEC. Where it and the plan disagree, the plan
wins, and the roadmap wins over both on status. Do not implement from this file.
────────────────────────────────────────────────────────────────────────────
-->
